...
如果第 2 步已经产生了比较清晰的假设，就用它起手：*"从代码库来看，这看起来像一个 [brand / product] 界面 - 这和你的意图一致吗？还是我们应该用别的方式来定义它？"*
...
- **已有代码**（有 CSS tokens、组件、运行中的网站）："我可以生成一份 DESIGN.md，记录你的视觉系统（colors、typography、components），这样后续 variants 就能持续贴合品牌。要现在做吗？"
