...
### 首次输入延迟（FID < 100ms）/ 交互到下次绘制（INP < 200ms）
*   拆分长任务
*   延迟非关键 JavaScript
*   将重计算放到 Web Workers
*   缩短 JavaScript 执行时间
...
**重要**：要在真实设备和真实网络环境下测试。桌面 Chrome + 快网并不具有代表性。
...
*   **不同设备**：在低端 Android 上测试，不要只在旗舰 iPhone 上测
*   **慢网环境**：限速到 3G 看体验
*   **无功能回归**：确认功能没有被优化坏
*   **用户感知**：它是否真的“感觉更快了”？
