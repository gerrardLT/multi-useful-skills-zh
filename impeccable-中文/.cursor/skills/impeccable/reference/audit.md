...
对照父级 impeccable skill 中所有 **DON'T** 指南（当前上下文已加载）进行检查。寻找 AI 生成痕迹（AI 配色、渐变文字、玻璃拟态、hero metrics、卡片网格、泛化字体）以及通用设计反模式（彩底灰字、嵌套卡片、bounce easing、重复文案）。

**评分 0-4**：0=AI 生成痕迹展览馆（5+ 明显痕迹），1=AI 美学很重（3-4 个痕迹），2=存在一些痕迹（1-2 个明显点），3=总体干净（只剩细微问题），4=没有 AI 痕迹（有辨识度、带设计意图）
