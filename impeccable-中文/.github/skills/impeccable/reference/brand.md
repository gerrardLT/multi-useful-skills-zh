...
品牌页面有资格使用 Committed、Full palette 和 Drenched。就用。一个 hero 被高饱和色彻底占领，并不算过火，那就是语气本身。那种米色配柔灰蓝的落地页，只是在否认自己所处的 register。
...
- 不要默认把所有东西居中。左对齐加不对称布局，会显得更像被设计过；严格网格则体现自信结构。一个居中 hero 再配 icon-title-subtitle 卡片堆，很容易直接变模板味。
...
- **搜索时找品牌的“实体感”，不是泛泛品类。** “刮痕木桌上的手工意面”比“Italian food”强；“暮色下石灰岩酒店立面前的柏树”比“luxury hotel”强。
- **一张有决断的图，比五张平庸图更有价值。** Hero 图应该一次性把情绪钉住，多塞几张图库图并不能补救犹豫。
- **Alt text 也是品牌语气的一部分。** “海边露台上手切的海岸风 fettuccine”比“pasta dish”更有声音。
...
- 用 monospace 作为“技术感 / 开发者感”的偷懒速记。如果品牌本身不技术，mono 只会像 costume。
